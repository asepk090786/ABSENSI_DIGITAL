                    ...
                    @else
                        <div class="table-responsive">
                            <table class="table table-striped table-hover">
                                ...
                                <tbody>
                                    @foreach($gurupiket as $index => $item)
                                        <tr>
                                            <td>{{ $index + 1 }}</td>
                                            <td>
                                                @if($item->foto)
                                            ...
                                            <td>
                                                <div class="btn-group" role="group">
                                                    <a href="{{ route('guru_piket.show', $item->id) }}" class="btn btn-sm btn-info">
                                                        <i class="ti ti-eye"></i>
                                                    </a>
                                                    <a href="{{ route('guru_piket.edit', $item->id) }}" class="btn btn-sm btn-warning">
