    ...
    <div class="col-md-8">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title fw-semibold m-0">Edit Guru</h4>
                ...
                <form method="POST" action="{{ route('guru.update', $guru->id) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-2">
                            ...
                            <input type="text" name="pangkat_golongan" class="form-control @error('pangkat_golongan') is-invalid @enderror" value="{{ old('pangkat_golongan', $guru->pangkat_golongan ?? '') }}" placeholder="Contoh: IV/a">
