...
@section('content')
    <h3>Buat Template Sertifikat</h3>
    <form method="POST" action="{{ route('pengembangan.templates.store') }}" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select name="output_format" class="form-control">
                    ...
                    <option value="docx" {{ old('output_format') == 'docx' ? 'selected' : '' }}>Word (.docx)</option>
            ...
            <div class="col-md-3 mb-3">
                ...
                <select name="page_orientation" class="form-control">
                    <option value="portrait" {{ old('page_orientation') == 'portrait' ? 'selected' : '' }}>Portrait</option>
                    <option value="landscape" {{ old('page_orientation') == 'landscape' ? 'selected' : '' }}>Landscape</option>
                </select>
            </div>
        </div>
        <div class="mb-3">
        ...
        <input type="hidden" id="placeholderPositions" name="placeholder_positions" value="{{ old('placeholder_positions', '') }}" />
        <div class="mb-3">
        ...
        <div id="imageEditorContainer" class="card mb-3">
            ...
            <div class="card-body">
                <div id="templateEditor" class="border rounded mx-auto" style="position:relative;width:100%;max-width:900px;aspect-ratio:210 / 297;background-color:#f8f9fa;background-size:contain;background-position:center;overflow:hidden;">
        ...
        <div class="mb-3">
            <div class="card bg-light border-secondary">
                <div class="card-body p-3">
                    <h6 class="card-title mb-2">Contoh Template HTML</h6>
