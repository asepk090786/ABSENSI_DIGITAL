            ...
            <div class="card">
                <div class="card-header">
                    <div class="row align-items-center">
                        <div class="col">
                            <h4 class="card-title mb-0">Tugas Mengajar - {{ $guru->user->name ?? $guru->nama }}</h4>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                        <span class="badge bg-secondary">Semua Kelas Tingkat {{ $tingkat }}</span>
                                                    @endif
                                                </td>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <p class="mb-2">
                                            ...
                                            <span class="badge bg-primary">{{ $tugasGuru->flatten()->count() }}</span>
                                        </p>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mb-2">
                                            <strong>Tugas Aktif:</strong> 
                                            <span class="badge bg-success">{{ $tugasGuru->flatten()->where('is_active', 1)->count() }}</span>
                                        </p>
                                    </div>
                                    <div class="col-md-4">
                                        <p class="mb-2">
                                            <strong>Mata Pelajaran:</strong> 
                                            <span class="badge bg-info">{{ $tugasGuru->flatten()->pluck('mata_pelajaran_id')->unique()->count() }}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
