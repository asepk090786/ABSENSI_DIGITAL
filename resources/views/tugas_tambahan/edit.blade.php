...
<div class="container-fluid">
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="page-title">
                    <i class="ti ti-briefcase me-2"></i>Edit Tugas Tambahan
                </h2>
            </div>
        </div>
    </div>
...
<div class="page-wrapper">
    <div class="container-xl">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form action="{{ route('tugas_tambahan.update', $tugaTambahan->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-control @error('tenaga_pendidikan_id') is-invalid @enderror" 
                                    ...
                                    @foreach ($tenagaPendidikan as $tp)
                                        <option value="{{ $tp->id }}" @selected($tugaTambahan->tenaga_pendidikan_id == $tp->id)>
                                            {{ $tp->nama }} ({{ $tp->nip }})
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('tugas') is-invalid @enderror" 
                                       ...
                                       value="{{ old('tugas', $tugaTambahan->tugas) }}" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('keterangan') is-invalid @enderror" 
                                          ...
                                          placeholder="Deskripsi detail tentang tugas ini">{{ old('keterangan', $tugaTambahan->keterangan) }}</textarea>
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" id="is_active" name="is_active" 
                                           value="1" @checked(old('is_active', $tugaTambahan->is_active))>
