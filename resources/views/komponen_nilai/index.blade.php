                ...
                <form method="POST" action="{{ route('komponen_nilai.store') }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="tujuan_pembelajaran" class="form-control @error('tujuan_pembelajaran') is-invalid @enderror" rows="3">{{ old('tujuan_pembelajaran') }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="alur_tujuan_pembelajaran" class="form-control @error('alur_tujuan_pembelajaran') is-invalid @enderror" rows="3">{{ old('alur_tujuan_pembelajaran') }}</textarea>
                        ...
                        <div class="col-md-12">
                            ...
                            <textarea name="indikator_kriteria" class="form-control @error('indikator_kriteria') is-invalid @enderror" rows="3">{{ old('indikator_kriteria') }}</textarea>
