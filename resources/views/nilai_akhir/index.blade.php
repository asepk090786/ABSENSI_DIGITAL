@extends('layouts.app', ['pageSlug' => 'nilai_akhir'])
        ...
        <div class="card">
            <div class="card-header border-0 pt-3 pb-2">
                <div class="row align-items-center">
                    <div class="col">
                        <h4 class="card-title fw-semibold m-0">Penilaian Akhir Peserta Didik</h4>
                    ...
                    <div class="col-auto">
                        <a href="{{ route('nilai_akhir.rekap') }}" class="btn btn-primary">
                            <i class="ti ti-file-text me-1"></i>Rekapitulasi
                        </a>
                    </div>
                </div>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ route('nilai_akhir.index') }}" class="mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="card bg-success text-white">
                                <div class="card-body">
                                    ...
                                    <h2 class="mb-0">{{ $rekapData->where('status', 'TUNTAS')->count() }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-warning text-white">
                                <div class="card-body">
                                    ...
                                    <h2 class="mb-0">{{ $rekapData->where('status', 'BELUM TUNTAS')->count() }}</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="card bg-info text-white">
                                <div class="card-body">
                                    ...
                                    <h2 class="mb-0">
                                        {{ $rekapData->whereNotNull('final_score')->count() ? number_format($rekapData->whereNotNull('final_score')->avg('final_score'), 2) : '-' }}
                                    </h2>
                                </div>
                            </div>
                        </div>
                ...
                @else
                    <div class="alert alert-info">
                        ...
                        Silakan pilih kelas dan mata pelajaran untuk menampilkan penilaian akhir
                    </div>
                @endif
            </div>
        </div>
