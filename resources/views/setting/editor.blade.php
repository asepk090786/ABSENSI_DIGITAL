    ...
    <div class="row mt-4">
        ...
        <div class="col-md-6">
            <div class="card h-100 border">
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="collabora_wopi_host">WOPI Host</label>
                    ...
                    <div class="form-text">Host yang digunakan untuk menghasilkan URL WOPI. Biasanya sama dengan APP_URL.</div>
                </div>
            </div>
        </div>
    </div>
