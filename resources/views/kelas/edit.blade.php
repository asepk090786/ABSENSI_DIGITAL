    ...
    <div class="col-md-10 mx-auto">
        <div class="card mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h4 class="card-title fw-semibold m-0">Edit Kelas</h4>
        ...
        <div class="card">
            <div class="card-header d-flex align-items-center justify-content-between">
                <div>
                    <h4 class="card-title fw-semibold m-0">Siswa di Kelas Ini</h4>
                    <div class="text-muted small">Tambahkan, eksport, atau import siswa khusus kelas ini.</div>
                </div>
                <div >
                    <a href="{{ route('kelas.siswa.export', ['kela' => $kelas->id]) }}" class="btn btn-sm btn-info btn-modern">
                        <i class="ti ti-download me-1"></i>Export Siswa
                    </a>
                    <button type="button" class="btn btn-sm btn-success btn-modern" data-bs-toggle="modal" data-bs-target="#modalImportSiswa">
            ...
            <div class="card-body">
                <div class="border rounded p-3 mb-4">
                    <h6 class="mb-2">Tambah Siswa ke {{ $kelas->nama_kelas }}</h6>
                ...
                <div class="border rounded p-3 mb-4 bg-light">
                    <h6 class="mb-2">Tambah Siswa dari Database</h6>
                    <p class="text-muted small mb-2">Pilih siswa yang sudah terdaftar di database tapi belum memiliki kelas.</p>
