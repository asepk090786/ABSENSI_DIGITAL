    ...
    <div class="col-md-10 mx-auto">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('guru.index')); ?>" class="btn btn-secondary btn-sm">Kembali</a>
            </div>
            <div class="card-body">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mt-4">
                        ...
                        <a href="<?php echo e(route('guru.index')); ?>" class="btn btn-secondary">Batal</a>
                    </div>
                </form>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'guru'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HYPE FLEX\Desktop\Project_absen\ABSENSI_DIGITAL\absensi_digital\resources\views/guru/create.blade.php ENDPATH**/ ?>