...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        <span class="badge bg-light text-dark px-3 py-2">
            <i class="ti ti-calendar me-1"></i><?php echo e(date('d F Y')); ?>
    ...
    <div class="card-body py-4">
        <div class="d-flex align-items-center">
            ...
            <div class="text-white">
                <h3 class="mb-1 text-white">Selamat Datang, <?php echo e(auth()->user()->name ?? 'User'); ?>! 👋</h3>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="h2 mb-0"><?php echo e($guru ?? 0); ?></div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-0 pt-0">
                <a href="<?php echo e(route('guru.index')); ?>" class="text-primary small text-decoration-none">
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="h2 mb-0"><?php echo e($siswa ?? 0); ?></div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-0 pt-0">
                <a href="<?php echo e(route('siswa.index')); ?>" class="text-success small text-decoration-none">
                    Lihat Detail <i class="ti ti-chevron-right"></i>
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="h2 mb-0"><?php echo e($kelas ?? 0); ?></div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-0 pt-0">
                <a href="<?php echo e(route('kelas.index')); ?>" class="text-warning small text-decoration-none">
                    Lihat Detail <i class="ti ti-chevron-right"></i>
                </a>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <div class="h2 mb-0"><?php echo e($absensi ?? 0); ?></div>
                    </div>
                </div>
            </div>
            <div class="card-footer bg-transparent border-0 pt-0">
                <a href="<?php echo e(route('absensi.index')); ?>" class="text-purple small text-decoration-none">
                    Lihat Detail <i class="ti ti-chevron-right"></i>
                </a>
            </div>
        </div>
    ...
    <div class="col-lg-6">
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body pt-0">
                <div class="row g-2">
                    <div class="col-6">
                        <a href="<?php echo e(route('absensi.index')); ?>" class="btn btn-light border w-100 py-3 text-start">
                            <i class="ti ti-clipboard-check text-primary me-2"></i>Input Absensi
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('agenda_kelas.index')); ?>" class="btn btn-light border w-100 py-3 text-start">
                            <i class="ti ti-calendar-event text-success me-2"></i>Lihat Agenda
                        </a>
                    </div>
                    <div class="col-6">
                        <a href="<?php echo e(route('jam_belajar.index')); ?>" class="btn btn-light border w-100 py-3 text-start">
            ...
            <div class="card-body pt-0">
                <div class="d-flex align-items-center py-2 border-bottom">
                    ...
                    <div>
                        ...
                        <div class="text-muted small"><?php echo e(\Carbon\Carbon::now()->translatedFormat('l, d F Y')); ?></div>
                    </div>
                </div>
                <div class="d-flex align-items-center py-2 border-bottom">
                    ...
                    <div>
                        ...
                        <div class="text-muted small" id="currentTime"><?php echo e(date('H:i:s')); ?> WIB</div>
                    </div>
                </div>
                <div class="d-flex align-items-center py-2">
                    ...
                    <div>
                        ...
                        <div class="text-muted small"><?php echo e($tahunAjaran ?? 'Belum Dipilih'); ?> - <?php echo e($semestrName ?? 'Belum Dipilih'); ?></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row g-3">
                    <div class="col-md-3 col-6">
                        <div class="rounded-3 p-3 text-center" style="background: rgba(16, 185, 129, 0.1);">
                            <div class="h2 mb-1 text-success"><?php echo e($hadir ?? 0); ?></div>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="rounded-3 p-3 text-center" style="background: rgba(245, 158, 11, 0.1);">
                            <div class="h2 mb-1 text-warning"><?php echo e($izin ?? 0); ?></div>
                            <div class="text-muted small">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="rounded-3 p-3 text-center" style="background: rgba(59, 130, 246, 0.1);">
                            <div class="h2 mb-1 text-info"><?php echo e($sakit ?? 0); ?></div>
                            <div class="text-muted small">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="rounded-3 p-3 text-center" style="background: rgba(239, 68, 68, 0.1);">
                            <div class="h2 mb-1 text-danger"><?php echo e($alpa ?? 0); ?></div>
                            <div class="text-muted small">
...
<?php echo $__env->make('layouts.app', ['pageSlug' => 'dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\HYPE FLEX\Desktop\Project_absen\ABSENSI_DIGITAL\absensi_digital\resources\views/home.blade.php ENDPATH**/ ?>