        ...
        <div class="container container-tight py-4">
            ...
            <div class="logos-container">
                <div class="simadis-logo-wrapper logo-display">
                    <img src="<?php echo e(asset('images/simadis-logo.svg')); ?>" alt="SIMADIS Logo" style="width: 100%; height: auto; max-width: 340px;">
                </div>
            ...
            <?php if($sekolah): ?>
                <div class="school-info">
                    <div class="school-name"><?php echo e($sekolah->nama_sekolah); ?></div>
                    <?php if($sekolah->alamat): ?>
                        <div class="school-address"><?php echo e($sekolah->alamat); ?></div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" 
                                       placeholder="email@contoh.com atau username" value="<?php echo e(old('login')); ?>" required autofocus>
                            </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-center mt-4">
                            <small class="footer-text">&copy; <?php echo e(date('Y')); ?> SIMADIS - Sistem Manajemen Absensi Digital</small>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\Users\HYPE FLEX\Desktop\Project_absen\ABSENSI_DIGITAL\absensi_digital\resources\views/auth/login.blade.php ENDPATH**/ ?>